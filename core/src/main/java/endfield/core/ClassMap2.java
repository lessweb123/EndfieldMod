...
import endfield.world.blocks.distribution.StackConveyor2;
...
final class ClassMap2 {
	...
	static void load() {
		...
		classes.put("BuildWeapon2", BuildWeapon2.class);
		...
		classes.put("Conveyor3", Conveyor3.class);
		classes.put("ConveyorBuild3", Conveyor3.ConveyorBuild3.class);
		...
		classes.put("StackConveyor2", StackConveyor2.class);
		classes.put("StackConveyorBuild2", StackConveyor2.StackConveyorBuild2.class);
