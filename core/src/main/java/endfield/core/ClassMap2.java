...
final class ClassMap2 {
	...
	static void load() {
		...
		classes.put("DirectionalUnloader2", DirectionalUnloader2.class);
		classes.put("DirectionalUnloaderBuild2", DirectionalUnloader2.DirectionalUnloaderBuild2.class);
		...
		classes.put("Unloader2", Unloader2.class);
		classes.put("UnloaderBuild2", Unloader2.UnloaderBuild2.class);
