...
public class ShockWaveAbility extends Ability {
	...
	public Color hitColor = Pal2.ancientLightMid;

	public Sound shootSound = Sounds2.shock;

	public Effect shootEffect = Fx2.circleOut;
	public Effect hitEffect = Fx2.hitSparkLarge;
