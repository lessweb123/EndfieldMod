...
public class StackConveyor2 extends StackConveyor {
	public boolean onlyCarry = true;
	public TextureRegion edge2Region;
	public TextureRegion[] topRegions;

	public StackConveyor2(String name) {
		super(name);
	...
	public void load() {
		...
		topRegions = Sprites.splitArray(Core.atlas.find(name + "-top"), 32, 1);
	}

	public class StackConveyorBuild2 extends StackConveyorBuild {
		@Override
		public void draw() {
			...
			//count
			Drawn.drawText(items.total() + "", Tmp.v1.x, Tmp.v1.y - 2f);
		}
