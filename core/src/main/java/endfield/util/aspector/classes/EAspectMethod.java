...
public class EAspectMethod extends EMethod {
	...
	public EAspectMethod(ClassDecl<?> declaring, String methodName, List<EParameter> parameters, EAnnotatedType<?> returnType, int flag, Using u, List<EAnnotation> annotations) {
