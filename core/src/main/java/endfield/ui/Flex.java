...
public class Flex extends WidgetGroup {
	protected final Seq<FlexCell<?>> cells = new Seq<>(FlexCell.class);
	...
	public FlexCell<ScrollPane> pane(Cons<Table> consumer) {
		return pane(Core.scene.getStyle(ScrollPane.ScrollPaneStyle.class), consumer);
	}
	...
	public FlexCell<ScrollPane> pane(Element element) {
		return pane(Core.scene.getStyle(ScrollPane.ScrollPaneStyle.class), element);
	}
	...
	public FlexCell<Label> add(CharSequence text, Color color) {
		return add(new Label(text, new Label.LabelStyle(Core.scene.getStyle(Label.LabelStyle.class).font, color)));
	}
	...
	public FlexCell<TextButton> button(String text, Drawable image, float imagesize, Runnable clicked) {
		return button(text, image, Core.scene.getStyle(TextButton.TextButtonStyle.class), imagesize, clicked);
	}
	...
	public FlexCell<TextButton> buttonCenter(String text, Drawable image, float imagesize, Runnable clicked) {
		return buttonCenter(text, image, Core.scene.getStyle(TextButton.TextButtonStyle.class), imagesize, clicked);
	}

	public FlexCell<TextButton> buttonCenter(String text, Drawable image, Runnable clicked) {
		return buttonCenter(text, image, Core.scene.getStyle(TextButton.TextButtonStyle.class), image.imageSize(), clicked);
	}
